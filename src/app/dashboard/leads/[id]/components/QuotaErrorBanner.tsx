...
export function QuotaErrorBanner({ quotaError, quotaRetryTimer, clearQuotaTimer }: QuotaErrorBannerProps) {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-50 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:w-max sm:max-w-sm flex items-center gap-3 rounded-xl border border-amber-500/30 bg-[#1a1200]/95 backdrop-blur-sm px-4 py-3 shadow-xl">
      ...
      <button onClick={clearQuotaTimer}
        className="shrink-0 cursor-pointer rounded-lg border border-amber-500/30 bg-amber-500/15 px-2.5 py-1 text-[11px] font-medium text-amber-400 transition-colors hover:bg-amber-500/25">
