    ...
    <div className="min-h-screen bg-[var(--color-bg-page)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8">
        ...
        <LeadHeaderStrip
          ...
          backTo={backTo}
          badge={
            <span className="inline-flex items-center gap-1 rounded-[var(--radius-sm)] bg-[var(--color-danger)]/12 px-2.5 py-0.5 text-[10px] font-medium text-[var(--color-danger)]">
        ...
        <div className="grid gap-6 lg:grid-cols-[3fr_2fr]">
          ...
          <div className="space-y-6 order-1 lg:order-2">
            ...
            <OpportunityScoreExplanation
              websiteStatus={biz.website_status ?? "no_website"}
