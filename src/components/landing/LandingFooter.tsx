                  ...
                  {status === "subscribed" ? (
                    ...
                    >
                      <input
                        ...
                        className={`min-h-[44px] min-w-0 flex-1 rounded-[var(--radius-sm)] border bg-[var(--color-bg-elevated)] px-3 py-2 text-sm text-[var(--color-text-primary)] placeholder:text-[var(--color-text-tertiary)] outline-none transition disabled:opacity-50 ${validationError ? "border-[var(--color-danger)]/50 focus:border-[var(--color-danger)]/70" : "border-[var(--color-border-subtle)] focus:border-[var(--color-accent)]/50"}`}
                      />
                      <button
                        type="submit"
                        disabled={status === "loading"}
