            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-base lg:text-body leading-7 text-[var(--color-text-secondary)]">{step.desc}</p>
                </div>
              </motion.div>
            );
          })}
          ...
          <div className="rounded-[var(--radius-md)] border border-[var(--color-accent)]/15 bg-[var(--color-bg-elevated)] p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-2 text-base lg:text-body leading-7 text-[var(--color-text-secondary)]">
