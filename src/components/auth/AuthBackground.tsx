...
/**
 * Subtle animated canvas background for auth pages.
 *
 * Renders slow-moving light trails, faint network node pulses,
 * and a soft radar-like scanning glow — all at very low opacity
...
export default function AuthBackground() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      // ── 3. Particles (light trails) ────────────────────────────
      ctx!.strokeStyle = "rgba(138,151,119,0.06)";
      ctx!.lineWidth = 0.8;
      ctx!.beginPath();
      ...
      // ── 4. Particle connections (network topology) ──────────────
