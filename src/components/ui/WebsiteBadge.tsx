...
export function WebsiteBadge({ status }: { status: string }) {
  ...
  return (
    <span className="inline-flex items-center rounded-full border border-[var(--border)] px-2.5 py-0.5 text-xs font-medium text-[var(--text-tertiary)] whitespace-nowrap">
      {p.label}
    </span>
  );
}
