...
export function WebsiteBadge({ status }: { status: string }) {
  ...
  return (
    <span className="inline-flex items-center rounded-[var(--radius-sm)] bg-[var(--color-bg-elevated)] px-2.5 py-0.5 text-xs font-medium text-[var(--color-text-tertiary)] whitespace-nowrap">
      {p.label}
    </span>
  );
}