...
| 20 | **Cost-sensitive model routing deferred (note only): Flash-Lite for analysis, 3.5 Flash for pitches** | Gemini 3.5 Flash output ($9/M) is pricey at volume; but don't prematurely optimise — revisit when volume justifies. Model name per call-site makes it a 1-line change. | May 2026 |
